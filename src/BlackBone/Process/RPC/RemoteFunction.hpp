...
template<typename T>
RemoteFunction<T> GetRemoteFunction( Process& process, ptr_t ptr )
{
...
/// <returns>Function object</returns>
template<typename T>
RemoteFunction<T> GetRemoteFunction( Process& process, T ptr )
{
    return RemoteFunction<T>( process, ptr );
}
...
/// <returns>Function object</returns>
template<typename T>
RemoteFunction<T> GetRemoteFunction( Process& process, const std::wstring& modName, const char* name_ord )
{
